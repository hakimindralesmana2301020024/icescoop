...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/responsive.css') . '?v=' . (file_exists(FCPATH.'assets/css/responsive.css') ? filemtime(FCPATH.'assets/css/responsive.css') : time()); ?>">
    <!-- Google Fonts: include Berkshire Swash (same as About page) -->
...
<body>
    <header class="site-header">
        <div class="container">
            <div class="logo"><strong>Swett Scoop</strong></div>
            <nav class="main-nav" role="navigation">
                <button id="mobile-nav-toggle" class="mobile-nav-toggle" aria-expanded="false" aria-label="Toggle navigation">
                    <i class="bi bi-list" style="font-size:22px"></i>
                </button>
                <div class="nav-inner" id="main-nav-inner">
                    ...
                    ?>
                <?php $cart_target = $is_logged ? base_url('index.php/order/cart') : base_url('index.php/login?return=' . urlencode(base_url('index.php/order/cart'))); ?>
                <a href="<?= $cart_target; ?>" class="cart-link" title="Keranjang">
                ...
                <?php if ($is_logged): ?>
                    <div class="user-menu" id="user-menu">
                        <a href="#" class="user-toggle" id="user-toggle" aria-haspopup="true" aria-expanded="false" title="Pelanggan">
                        ...
                        <div class="user-dropdown" id="user-dropdown" role="menu" aria-labelledby="user-toggle">
                            <div class="user-item user-name">Hi, Pelanggan</div>
    ...
    // Mobile nav toggle
    (function(){
        var mbtn = document.getElementById('mobile-nav-toggle');
        ...
        document.addEventListener('click', function(e){
            if (!mnav.contains(e.target) && !mbtn.contains(e.target)){
                mnav.classList.remove('open');
                mbtn.setAttribute('aria-expanded','false');
            }
        });
